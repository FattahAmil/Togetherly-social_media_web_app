...
<script>
    ...
    function removeMe(element, followedId) {
...
<div class="widget widget-who-following">
                                ...
                                <div class="following-item d-flex justify-content-between align-items-center" >
                                    ...
                                    <span class="add-friend" id="user-<?php echo $donner1['nom_user'];?>" onclick="removeMe(this, <?php echo  $donner1['id_user']; ?>)"><a style="cursor: pointer;">Add</a></span>
