<div class="news-feed news-feed-form">
                                 <h3 class="news-feed-title">Create New Post</h3>
                                    ...
                                    <ul class="button-group d-flex justify-content-between align-items-center">
                                        <li class="photo-btn">
                                        <label for="photo_upload"><i class="flaticon-gallery" style="color: red;margin-right: 4px;"></i>Upload photo </label>
                                        <input type="file" name="photo" id="photo_upload" style="display:none;">
                                        </li>
                                        <li class="video-btn">
                                        <label for="video_upload"><i class="flaticon-video" style="color: green;"></i> Upload video</label>
